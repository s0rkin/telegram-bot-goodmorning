    ...
    for attempt_no in range(num_retries):
        try:
            ...
            if attempt_no < (num_retries - 1):
                ...
                return "Погода в Москве: не удалось получить, API ERROR! " + str(num_retries) + " retry expired!"
        return "Погода в Москве: " + (str(int(t["main"]["temp"]))) + "°C " + t["weather"][0]["description"] + ", ощущается как " + (str(int(t["main"]["feels_like"])) + "°C")
...
def get_random_wisdom(num_retries = 10):
    for attempt_no in range(num_retries):
        try:
            r = requests.post(os.getenv("WISDOM_URL"), headers = header)
            t = json.loads(r.text)
            ...
            if attempt_no < (num_retries - 1):
                ...
                print("API (get_random_wisdom) ERROR! 10 retries expired!")
                return "\n<b>Мудрость дня:</b> API ERROR! 10 retries expired!"
